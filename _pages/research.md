...
Our RAG system combines a ColBERT-based retriever that enables precise evidence retrieval through semantically rich representations of policy texts, and LLM fine-tuned via Direct Preference Optimization (DPO) to align responses with human judgments of correctness and clarity [Preprint'25d].
...
- Unified framework for discovering latent thematic structure of climate narratives across Meta ad texts and Bluesky posts by combining semantic embeddings, HDBSCAN clustering, and LLM-based summarization and theme generation [Preprint'25e].
