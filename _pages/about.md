...
My research interest broadly lies in **Social media mining and analysis** with **Natural Language Processing (NLP)** and **Computational Social Science (CSS)**. The information provided in super-connected media is often shaped by people's underlying lifestyle, well-being, health related choices and motivations, which may attract specific stakeholders to advance their interests to interact with potential users by adapting their messaging. I am interested in **characterizing users** and **messaging** on social media. 
